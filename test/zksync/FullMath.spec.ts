...
describe('BitMath', () => {
    ...
    const fixture = async () => {
        ...
        const artifact = await deployer.loadArtifact("FullMathTest");
        return (await deployer.deploy(artifact, [])) as FullMathTest;
    ...
    beforeEach('deploy FullMathTest', async () => {
        ...
        fullMath = await fixture()
        console.log("FullMathTest.address", fullMath.address)
    })
